...
const adminNav = [
  ...
  { to: '/admin/fraud-map', icon: Activity, key: 'Fraud Map Track' },
  { to: '/admin/news', icon: ClipboardList, key: 'News Events' },
];
...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <aside className="z-30 hidden min-h-screen w-[260px] flex-col border-r border-neutral-900 bg-[#050505] pt-[84px] md:fixed md:left-0 md:top-0 md:flex md:pt-0">
      <motion.div
